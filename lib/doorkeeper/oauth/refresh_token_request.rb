  ...
  module OAuth
    class RefreshTokenRequest < BaseRequest
      ...
      def load_client(credentials)
        Doorkeeper.application_model.by_uid_and_secret(credentials.uid, credentials.secret)
      end
      ...
      def refresh_token_revoked_on_use?
        Doorkeeper.access_token_model.refresh_token_revoked_on_use?
      end
      ...
      def create_access_token
        @access_token = Doorkeeper.access_token_model.create!(access_token_attributes)
      end
